    ...
    render() {
        ...
        return (
            <div>{this.state.loading ? 
                <RegLoader /> 
                :<div style={{display: 'flex', flexDirection: 'row-reverse', justifyContent: 'space-around'}}> <div>
                {/* <Map func={this.getLocationOfMap} /> */}
                ...
                <NormalBtn text='SignUp' disabled={!this.state.formValid} func={this.checname} />
